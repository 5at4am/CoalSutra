...
export default function SourceChip({ citation, onClick }: SourceChipProps) {
  return (
    <button
      ...
      className="inline-flex max-w-full items-center gap-1 rounded-full border border-source/30 bg-source-light px-3 py-1 text-xs font-medium text-source-dark transition-colors hover:bg-source-chip dark:border-source/40 dark:bg-source/15 dark:text-emerald-300 dark:hover:bg-source/25"
    >
